...
function UpdateNote() {
  ...
  return (
    <div className="w-11/12 max-w-xl mx-auto mt-20 mb-5">
      <form
      ...
      >
        ...
        <button
          type="submit"
          className=" w-36 text-lg font-semibold text-slate-500 mt-4 mb-1 py-3 px-4 border-2 border-slate-500 rounded-sm hover:border-blue-500 hover:text-slate-600 hover:-translate-y-1 transition-all"
        >
          Update Note
        </button>
      </form>
